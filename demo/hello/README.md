...
* **[api_config.yaml](file:///Users/nabeshimamasataka/CLionProjects/embwasm/demo/hello/api_config.yaml)**:
...
2. **関数ポインタを排除した直接ディスパッチャの生成**:
   * [gen_api.py](file:///Users/nabeshimamasataka/CLionProjects/embwasm/tools/codegen/gen_api.py) が [api_config.yaml](file:///Users/nabeshimamasataka/CLionProjects/embwasm/demo/hello/api_config.yaml) を解析します。
